package azuredevops.toolwindow.filters
...
class PullRequestFilterPanel(
    ...
    init {
        ...
        projectChip =
            FilterChipComponent(
                ...
                onClear = {
                    updateFilter(currentValue.copy(projectFilter = null, repositoryFilter = null))
    ...
    private fun showQuickFilterPopup(button: JComponent) {
        ...
        val items =
            mutableListOf<QuickFilterMenuItem>(
        ...
        val step =
            object : BaseListPopupStep<QuickFilterMenuItem>("Quick Filters", items) {
                override fun getTextFor(value: QuickFilterMenuItem): String =
                    when (value) {
                ...
                override fun onChosen(
                    selectedValue: QuickFilterMenuItem,
                    finalChoice: Boolean,
                ): PopupStep<*>? {
                    when (selectedValue) {
                        is QuickFilterMenuItem.Filter ->
    ...
    private fun showAuthorPopup(chip: FilterChipComponent) {
        ...
        FilterPopupUtil.showUserPopup(
            ...
            onSelected = { author ->
                ...
                val icon =
                    avatarService.getAvatar(author.imageUrl, 16) {
                        chip.repaint()
                    }
    ...
    private fun showRepositoryPopup(chip: FilterChipComponent) {
        ...
        val repos =
            currentValue.projectFilter?.let { proj ->
...
private sealed class QuickFilterMenuItem {
    data class Filter(
        val filter: PullRequestQuickFilter,
    ) : QuickFilterMenuItem()
