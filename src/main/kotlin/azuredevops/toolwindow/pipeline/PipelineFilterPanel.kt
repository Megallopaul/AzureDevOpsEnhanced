package azuredevops.toolwindow.pipeline

import azuredevops.model.BuildDefinition
import azuredevops.toolwindow.filters.FilterBadgeIcon
import azuredevops.toolwindow.filters.FilterChipComponent
import azuredevops.toolwindow.filters.FilterPopupUtil
...
class PipelineFilterPanel(
    ...
    private fun showQuickFilterPopup(button: JComponent) {
        ...
        val items =
            mutableListOf<PipelineQuickFilterItem>(
        ...
        val step =
            object : BaseListPopupStep<PipelineQuickFilterItem>("Quick Filters", items) {
                override fun getTextFor(value: PipelineQuickFilterItem): String =
                    when (value) {
...
private sealed class PipelineQuickFilterItem {
    data class Filter(
        val filter: PipelineQuickFilter,
    ) : PipelineQuickFilterItem()
