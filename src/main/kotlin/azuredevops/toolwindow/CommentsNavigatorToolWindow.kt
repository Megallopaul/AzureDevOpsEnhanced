...
class CommentsNavigatorPanel(
    ...
    init {
        ...
        val visibilityService =
            azuredevops.services.CommentsVisibilityService
                .getInstance(project)
    ...
    private fun openCommentDialog(item: CommentItem) {
        val commentsService =
            azuredevops.services.PullRequestCommentsService
                .getInstance(project)
                    ...
                    background =
                        if (isSelected) {
                            ...
                            when {
                                ...
                                value.thread.status == azuredevops.model.ThreadStatus.Pending -> {
                ...
                JLabel().apply {
                    icon =
                        when {
                            ...
                            value.thread.status == azuredevops.model.ThreadStatus.Pending -> AllIcons.RunConfigurations.TestState.Run
