...
import azuredevops.actions.AbandonPullRequestAction
import azuredevops.actions.CompletePullRequestAction
import azuredevops.actions.ConvertToDraftPullRequestAction
import azuredevops.actions.SetAutoCompletePullRequestAction
...
import azuredevops.toolwindow.filters.PullRequestFilterPanel
import azuredevops.toolwindow.filters.PullRequestSearchValue
    ...
    private fun showContextMenu(e: MouseEvent) {
        ...
        popup.add(
            JMenuItem("Enter This Branch").apply {
                addActionListener {
                    azuredevops.services.PullRequestBranchService
                        .getInstance(project)
