...
class PullRequestDetailsPanel(
    ...
    fun setPullRequest(pullRequest: PullRequest?) {
        ...
        if (currentPullRequest?.pullRequestId == pullRequest.pullRequestId) {
            ...
            val hasReviewerVoteChanges =
                if (currentPullRequest?.reviewers != null && pullRequest.reviewers != null) {
    ...
    private fun updateReviewers(pullRequest: PullRequest) {
        ...
        reviewers.forEach { reviewer ->
            ...
            val reviewerLabel =
                JBLabel("$reviewerName$isRequired").apply {
                    this.icon = icon
                    val color =
                        when {
    ...
    private fun createLayout(): JPanel {
        ...
        // Wrapper with scroll
        mainContainer.add(
            JBScrollPane(scrollPanel).apply {
