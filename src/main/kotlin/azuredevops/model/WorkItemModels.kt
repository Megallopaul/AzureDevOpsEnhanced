...
import azuredevops.util.DateUtil
...
data class WorkItem(
    ...
    companion object {
        fun stateColor(state: String): JBColor =
        ...
        fun typeColor(type: String): JBColor =
            when (type.lowercase()) {
        ...
        fun priorityColor(priority: Int?): JBColor? =
            when (priority) {
