...
import azuredevops.services.AzureDevOpsStatusBarService.BuildStatusSummary
...
class AzureDevOpsStatusBarWidget(
    ...
    private fun getBuildIcon(status: BuildStatusSummary): Icon =
        when (status) {
