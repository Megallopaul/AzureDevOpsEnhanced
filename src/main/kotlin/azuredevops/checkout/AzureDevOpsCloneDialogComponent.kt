...
import azuredevops.AzureDevOpsIcons
import azuredevops.services.GitTokenManager
 ...
 */
class AzureDevOpsCloneDialogComponent(
    ...
    init {
        ...
        accountComboBox.renderer =
            object : ColoredListCellRenderer<AzureDevOpsAccount>() {
