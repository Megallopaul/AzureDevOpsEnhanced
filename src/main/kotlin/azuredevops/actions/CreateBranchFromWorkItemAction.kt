...
import azuredevops.services.WorkItemBranchService
...
object CreateBranchFromWorkItemAction {
    ...
    private class CreateBranchDialog(
        ...
        private val branchNameField =
            JBTextField(defaultBranchName).apply {
        ...
        override fun doValidate(): com.intellij.openapi.ui.ValidationInfo? {
            ...
            if (name.isBlank()) {
                return com.intellij.openapi.ui
                    .ValidationInfo("Branch name is required", branchNameField)
            }
            if (name.contains(" ")) {
                return com.intellij.openapi.ui
                    .ValidationInfo("Branch name cannot contain spaces", branchNameField)
            }
            return null
        }
