...
import azuredevops.checkout.AuthType
import azuredevops.checkout.AzureDevOpsAccount
import azuredevops.checkout.AzureDevOpsAccountManager
import azuredevops.checkout.AzureDevOpsLoginDialog
import azuredevops.checkout.AzureDevOpsOAuthService
import azuredevops.services.PatValidationService
...
class AzureDevOpsAccountsConfigurable : Configurable {
    ...
    private fun revalidatePat(account: AzureDevOpsAccount) {
        ...
        ProgressManager.getInstance().run(
            object : Task.Modal(null, "Validating PAT...", false) {
