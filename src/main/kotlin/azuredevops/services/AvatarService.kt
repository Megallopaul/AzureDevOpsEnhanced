...
class AvatarService(
    ...
    private val icons: LinkedHashMap<String, DelegatingIcon> =
        object : LinkedHashMap<String, DelegatingIcon>(16, 0.75f, true) {
            override fun removeEldestEntry(eldest: MutableMap.MutableEntry<String, DelegatingIcon>?): Boolean = size > maxCacheSize
        }
    ...
    companion object {
        ...
        fun getInstance(project: Project): AvatarService = project.getService(AvatarService::class.java)
    }
    ...
    private fun makeCircular(image: BufferedImage): BufferedImage {
        ...
        val clip =
            java.awt.geom.Ellipse2D
                .Float(0f, 0f, size.toFloat(), size.toFloat())
        g2d.clip = clip
