...
class PullRequestCommentsService(
    ...
    companion object {
        ...
        private val ACTIVE_COMMENT_ATTRIBUTES =
        ...
        private val PENDING_COMMENT_ATTRIBUTES =
            TextAttributes().apply {
        ...
        private val RESOLVED_COMMENT_ATTRIBUTES =
            TextAttributes().apply {
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            try {
                ...
                threads.forEachIndexed { index, thread ->
                    logger.info(
                        "Thread #$index: id=${thread.id}, path=${thread.getFilePath()}, line=${thread.getRightFileStart()}, status=${thread.status}",
                    )
                }
