...
class PullRequestBranchService(
    ...
    companion object {
        fun getInstance(project: Project): PullRequestBranchService = project.getService(PullRequestBranchService::class.java)
    }
     ...
     */
    private fun findRemoteForBranch(
     ...
     */
    private fun createSafeBranchName(
        repository: GitRepository,
        prId: Int,
        sourceBranch: String,
    ): String {
